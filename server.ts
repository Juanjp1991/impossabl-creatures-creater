...
// Server-wide default reasoning effort for proxied models; a request may override it via
// `reasoningEffort`. Kept at "low" on measurement, not assumption: on the same lion brief
// gpt-5.6-sol produced 64 elements at low effort and 65 at high — identical quality for 63%
// more wall-clock (119s -> 194s) and 12x the reasoning tokens (341 -> 4307). Detail density is
